  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content bg-dark">
      ...
      <div class="modal-body">
        <form action="data.php?tambah_kategori=1" method="post">
          <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class="input-group-text" id="basic-addon1">Kode Kategori</span>
            </div>
...
<script src="../assets/dist/js/kategori.js"></script>
